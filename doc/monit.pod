...
No rights are granted except for those provided to you by Metaswitch Networks in
a separate written agreement, or for third party components as described in the
Clearwater Core Open Source Acknowledgements document.
